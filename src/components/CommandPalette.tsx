...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    },
    {
      id: 'nav-terceros',
      label: 'Directorio',
      description: 'Contactos, proveedores y organizaciones',
      icon: <Users className="h-4 w-4" />,
      action: () => navigate('/terceros'),
      category: 'navigation',
      keywords: ['directorio', 'terceros', 'contactos', 'personas', 'organizaciones', 'proveedores'],
    },
    {
      id: 'nav-clientes',
      label: 'Clientes',
    ...
    },
    {
      id: 'nav-servicios',
      label: 'Operaciones',
      description: 'Catálogo de servicios operativos',
      icon: <Briefcase className="h-4 w-4" />,
      action: () => navigate('/servicios'),
      category: 'navigation',
      keywords: ['operaciones', 'servicios', 'productos', 'ofertas'],
    },
    {
      id: 'nav-tareas',
      label: 'Proyectos',
      description: 'Tablero de proyectos y tareas',
      icon: <CheckSquare className="h-4 w-4" />,
      action: () => navigate('/tareas'),
      category: 'navigation',
      keywords: ['proyectos', 'tareas', 'tasks', 'pendientes', 'kanban'],
    },
    {
      id: 'nav-finanzas',
      label: 'Finanzas',
