  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "lg:hidden fixed z-[45] p-2 rounded-lg bg-sidebar text-sidebar-foreground shadow-lg border border-sidebar-border hover:bg-sidebar-accent transition-all duration-300",
