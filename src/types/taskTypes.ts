...
export interface Task {
  ...
  // De donde salio, para ordenarla arriba y (si aplica) marcarla:
  //   'todo'   = nacio de un pendiente del To-Do (arrastrado o convertido)
  //   'rapida' = escrita en el input rapido de Mis Tareas
  origen?: 'todo' | 'rapida';
