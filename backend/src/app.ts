...
import metaMensualRoutes from './routes/metaMensual.routes';
import metaDiarioRoutes from './routes/metaDiario.routes';
...
app.use('/api/meta-mensual', metaMensualRoutes);
app.use('/api/meta-diario', metaDiarioRoutes);
